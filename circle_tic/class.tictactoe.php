	...
	**/
	function displayGame()
	{
		...
		if (!$this->isOver())
		{
			...
			echo "
				<p align=\"center\">
					<input type=\"submit\" name=\"move\" value=\"Ok\" /><br/>
					<b>Great! it is now {$this->player}'s turn.</b></p>
			</div>";
		}
		else
		{
			...
			if ($this->isOver() != "Tie")
				...
				echo errorMsg("Oh No Looks like you've had a Cat's game. Want to try again?");
